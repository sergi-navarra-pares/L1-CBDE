...
euclidean_collection = chroma_client.get_or_create_collection(name="euc_sentences", metadata={"distance": "euclidean"})
manhattan_collection = chroma_client.get_or_create_collection(name="man_sentences", metadata={"distance": "manhattan"})
